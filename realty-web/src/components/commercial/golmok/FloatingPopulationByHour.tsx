...
interface FloatingPopulationByHourProps {
  data: any;
}

const FloatingPopulationByHour: React.FC<FloatingPopulationByHourProps> = ({ data }) => {
  if (!data || data.status !== 'success' || !data.data) {
    //console.log('[FloatingPopulationByHour] 데이터 없음:', data);
    return null;
  }
  ...
  //console.log('[FloatingPopulationByHour] API 데이터:', apiData);
...
export default FloatingPopulationByHour;
